...
import derlin.symbiosart.api.img.MirflickrApi;
...
public class ImagesService{
    ...
    // curl -X POST -H 'Content-Type:application/json' --data '{"wedding": 2}' http://localhost:8680/rest/img/get/10
    @POST
    @Path( "/get/{nbr}" )
    ...
    // curl -v -X POST -H 'Accept:application/xml' http://localhost:8680/rest/img/example/tagvector
    @POST
